...
{{ '[详细数据]({}/document/sphinx-cn/tutorials/misc/performance_test/1.7.0/cpp/data/result_channel_local_cpp.csv)'.format(code_site_root_path_url) }}
...
{{ '[详细数据]({}/document/sphinx-cn/tutorials/misc/performance_test/1.7.0/cpp/data/result_rpc_local_cpp.csv)'.format(code_site_root_path_url) }}
...
{{ '[详细数据]({}/document/sphinx-cn/tutorials/misc/performance_test/1.7.0/cpp/data/result_channel_cross_cpp.csv)'.format(code_site_root_path_url) }}
...
{{ '[详细数据]({}/document/sphinx-cn/tutorials/misc/performance_test/1.7.0/cpp/data/result_rpc_cross_cpp.csv)'.format(code_site_root_path_url) }}
